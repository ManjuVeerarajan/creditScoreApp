...
public class CustomerCreditReports {
	...
	public String toString() {
		return "Name: " + this.name + " - Nric: " + this.nric + " - BankruptcyCount: " + this.bankruptcyCount
				+ " - LegalSuitCount: " + this.legalSuitCount + " - TradeBureauCount: " + this.tradeBureauCount
				+ " - IScore: " + this.iScore + " - IScoreRiskGrade: " + this.iScoreRiskGrade + " - IScoreGradeFormat: "
				+ this.iScoreGradeFormat + " - BorrowerOutstanding: " + this.borrowerOutstanding
				+ " - LegalActionBankingCount: " + this.legalActionBankingCount + " - BankingCreditApprovedAmount: "
				+ this.bankingCreditApprovedAmount + " - BankingCreditPendingAmount: " + this.bankingCreditPendingAmount
				+ " - BankingCreditApprovedCount: " + this.bankingCreditApprovedCount + " - xmlString:" + this.xmlString
				+ " - JsonString: " + this.jsonString + " - CreatedAt: " + this.createdAt + " - UpdatedAt: "
				+ this.updatedAt + " - CustomerId: " + this.customerId + " - FilePath: " + this.filepath
				+ " - ExperianRequest: " + this.experianRequest;
	}
